export const products = [
	{
		...
		price: 55,
		description:
			'Waffles with whipped cream and a hint of maple syrup. Perfect for breakfast or dessert.',
	...
	{
		id: '9',
		name: 'Strawberry Cookie Sandwich',
		slug: 'cream-cupcakes',
		price: 33,
		description:
			'Tender cookies sandwiching a strawberry cream filling. A delightful treat for all occasions.',
